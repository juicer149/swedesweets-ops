...
def create_product(
    *,
    ...
    ProductProfile and the customer-facing translation are created as part of
    the same application transaction.
    """

    normalized_brand = normalize_required_text(
        brand,
        field_name="brand",
    )
    ...
    _validate_profile_category(category)
    ...
    try:
        ...
        raise InvalidProductData(
            f"Could not create product with SKU {sku}"
        ) from exc
...
def _validate_profile_category(
    ...
    valid_categories = {
        choice.value
        for choice in ProductProfile.Category
    }
...
def _validate_stock_unit(
    ...
    valid_units = {
        choice.value
        for choice in Product.StockUnit
    }

    if stock_unit not in valid_units:
        raise InvalidProductData(
            f"Unsupported stock unit: {stock_unit}"
        )
